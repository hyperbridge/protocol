...
contract('ProjectTimelineProposalVoting', function(accounts) {
    ...
    let projectTimelineProposalVotingContract;
    ...
    before(async () => {
        ...
        projectTimelineProposalVotingContract = await ProjectTimelineProposalVoting.deployed();
        await fundingStorage.registerContract("ProjectTimelineProposalVoting", blankAddress, projectTimelineProposalVotingContract.address);
    ...
    it("project contributor can vote for timeline proposal", async () => {
        try {
            ...
            await projectTimelineProposalVotingContract.vote(projectId, true, { from: contributorAccount });
    ...
    it("project contributor can vote against timeline proposal", async () => {
        try {
            ...
            await projectTimelineProposalVotingContract.vote(projectId, false, { from: contributorAccount });
    ...
    it("developer cannot finalize timeline proposal if no proposal is active", async () => {
        try {
            ...
            await projectTimelineProposalVotingContract.finalizeVoting(projectId, { from: developerAccount });
            assert.fail();
        } catch (e) {
            console.log(e.message);
        }
