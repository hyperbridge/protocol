...
var HyperbridgeTokenSale = artifacts.require('HyperbridgeTokenSale');
...
contract('HyperbridgeTokenSale', function ([owner1, owner2, owner3, investor, wallet, tokenWallet, purchaser, alice, bob, charlie]) {
    ...
    beforeEach(async function () {
        ...
        this.crowdsale = await HyperbridgeTokenSale.new(rate, wallet, hbxToken.address, tokenWallet, cap, this.openingTime, this.closingTime);
