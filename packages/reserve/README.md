<div align="center">
  ...
  <h1><code>HBX Reserve</code> for Hyperbridge</h1>
</div>

<br>

These are the official reserve contracts of the Hyperbridge ecosystem, built with Truffle, OpenZeppelin, Solidity.
