...
These are the protocol specification for the Hyperbridge ecosystem, currently built with Solidity and Web3.js. We plan to support more in the future.

## Quick Links

- 🌐 [Site](http://hyperbridge.org/)
- 📖 [Docs](http://docs.hyperbridge.org/protocol)
...
The Hyperbridge Protocol project is broken up into related types:

* Token - in the `packages/token` dir
* Funding - in the `packages/funding` dir
* Marketplace - in the `packages/marketplace` dir
* Crowdsale - in the `packages/crowdsale` dir
